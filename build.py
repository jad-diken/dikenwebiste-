  ...
  <div class="wrap">
    <div class="cols">
      <div>
        ...
        <p style="margin-top:16px;max-width:36ch">Distribution, motorcycles, delivery and investments. Jordan and Dubai.</p>
  ...
  <div class="wrap">
    <div class="cols">
      <div>
        ...
        <p style="margin-top:16px;max-width:36ch">التوزيع، الدراجات النارية، التوصيل والاستثمارات. الأردن ودبي.</p>
